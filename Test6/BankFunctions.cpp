...
void Bank::acc_write() {
    // Implement the acc_write function
    // ...
    
	ofstream MyFile1, MyFile2;
	read_data();
	MyFile1.open("Bank_Record.txt", ios::out|ios::app);
	MyFile1<<account_number<<","<<name<<","<<dob<<","
		   <<age<<","<<address<<","<<phone<<","<<depo
		   <<","<<acc_type<<","<<date<<","<<doc<<","<<interest<<"\n";
	MyFile1.close();
	MyFile2.open("Account_info.txt", ios::out|ios::app);
	MyFile2<<account_number<<","<<password<<","<<"\n"; 
	MyFile2.close();
}

void Bank::modify_account() {
    // Implement the modify_account function
    // ...
    	Bank ac;
	int test = 0;
	string acc_no;
	...
	if(test == 1)
	{
		...
		remove("Bank_Record.txt");
   		rename("temp.txt","Bank_Record.txt");	
...
void Bank::deposit_withdraw() {
    // Implement the deposit_withdraw function
    // ...
...
void Bank::search_rec() {
    // Implement the search_rec function
    // ...
       int test=0,rate;
    int choice, date1;
    float t;
...
void Bank::display_all() {
    // Implement the display_all function
    // ...
    int amount;
	cout<<"\n\n\t\tACCOUNT HOLDER LIST\n\n";
    cout<<"====================================================="
...
void fordelay(int j) {
    // Implement the fordelay function
    // ...
     int i,k;
    for(i=0;i<j;i++)
         k=i;
...
void employee() {
    // Implement the employee function
    // ...
    char pass[10];
    char c;
    string s, name;
...
void customer() {
    // Implement the customer function
    // ...
    char pass[10];
    char c;
